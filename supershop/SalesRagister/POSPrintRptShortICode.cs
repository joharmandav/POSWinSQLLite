...
namespace supershop
{
    public partial class POSPrintRptShortICode : Form
    {
        string DeftPrinter = null;
        public POSPrintRptShortICode(string saleno, string DefaultPrinter)
        {
            InitializeComponent();
        ...
        private void Run(DataTable reportds, DataTable reportdetail)
        {
            ...
            var GetDirectory = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
            report.ReportPath = GetDirectory + @"\Report\RptPOSShort2.rdlc";
