...
namespace supershop
{
    public partial class POSPrintRptA5Laundary : Form
    {
        string DeftPrinter = null;
        int customercode ;
        public POSPrintRptA5Laundary(string saleno, string DefaultPrinter,int custCode)
        {
            InitializeComponent();
        ...
        private void POSPrintRpt_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlpay = "";
                     ...
                     sql = " SELECT  si.sales_id AS salesid, " +
                                ...
                                " CASE WHEN si.taxapply = 1 THEN 'TX'  ELSE ''  END 'TaxApply', ct.CAT_NAME1 ,si.DeliveryDate ,si.ItemNote,si.PaymentMode,    " +
                                 " CASE WHEN si.discount is not null THEN si.discount WHEN si.discount is null THEN '0' END discount " +
                                ...
                                "INNER JOIN purchase pur ON  si.itemcode  = pur.product_id and si.TenentID  = pur.TenentID " +
                                "INNER JOIN CAT_MST ct ON pur.category  = ct.CATID and  si.TenentID  = ct.TenentID " +
                ...
                sqlpay = " SELECT * from sales_payment Where TenentID = " + Tenent.TenentID + " and sales_id= '" + toolsaleno.Text + "' and return_id=0 ";
        ...
        private void Run(DataTable reportds, DataTable reportdetail)
        {
            ...
            var GetDirectory = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
            report.ReportPath = GetDirectory + @"\Report\RptPOSA5Loundary.rdlc";
