...
namespace supershop
{
    public partial class POSPrintRptonlysave : Form
    {
        string DeftPrinter = null;
        public POSPrintRptonlysave(string saleno, string DefaultPrinter)
        {
            InitializeComponent();
        ...
        private void POSPrintRpt_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                int Cpages = this.reportViewer1.GetTotalPages();
        ...
        private void Run(DataTable reportds, DataTable reportdetail)
        {
            ...
            var GetDirectory = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
            report.ReportPath = GetDirectory + @"\Report\RptPOSonlysave.rdlc";
