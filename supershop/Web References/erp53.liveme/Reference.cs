...
namespace supershop.erp53.liveme {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WinConnectionSoap", Namespace="http://tempuri.org/")]
    public partial class WinConnection : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WinConnection() {
            this.Url = global::supershop.Properties.Settings.Default.Adv_POS_erp53_com1_WinConnection;
        ...
        /// <remarks/>
        public void GetConnectionAsync(int pqr, string abc) {
            this.GetConnectionAsync(pqr, abc, null);
        }
        
        /// <remarks/>
        public void GetConnectionAsync(int pqr, string abc, object userState) {
            ...
            this.InvokeAsync("GetConnection", new object[] {
                        pqr,
                        abc}, this.GetConnectionOperationCompleted, userState);
        }
