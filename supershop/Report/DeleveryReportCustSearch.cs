...
namespace supershop
{
    public partial class DeleveryReportCustSearch : Form
    {
        ...
        public void Databind()
        {
           ...
           string sqlCmd = "Select ID,(Name ||' - '|| NameArabic) as Name,Mobile,Address,EmailAddress from  customercredit where TenentID=" + Tenent.TenentID + " and PeopleType = 'Customer' ";           
        ...
        private void dtGrdvCustomerDetails_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == dtGrdvCustomerDetails.Columns["Select"].Index && e.RowIndex >= 0)
                {
                    ...
                    string customerName = dt1.Rows[0]["ID"].ToString();

                    DeliveryReport mkc1 = (DeliveryReport)Application.OpenForms["DeliveryReport"];
                    mkc1.CustomerPage4deliver = "DeleveryReportCustSearch";
                    mkc1.CustName4deliver = customerName;
                    mkc1.Show();
                    this.Hide();
                }
