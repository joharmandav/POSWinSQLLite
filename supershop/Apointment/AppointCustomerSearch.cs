...
namespace supershop
{
    public partial class AppointCustomerSearch : Form
    {
        ...
        public void Databind()
        {
            ...
            string sqlCmd = "Select ID,(Name ||' - '|| NameArabic) as Name,Mobile,Address,EmailAddress from  customercredit where TenentID=" + Tenent.TenentID + " and PeopleType = 'Customer' and id != '1' ";
        ...
        private void txtCustomerSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            Name = Name.Trim();
            string sqlCmd = "Select ID,(Name ||' - '|| NameArabic) as Name,Mobile,Address,EmailAddress from  customercredit where TenentID=" + Tenent.TenentID + " and PeopleType = 'Customer' and (Name like '%" + Name + "%' or  NameArabic like '%" + Name + "%') and id != '1' ";
            DataTable dt1 = DataAccess.GetDataTable(sqlCmd);
            dtGrdvCustomerDetails.DataSource = dt1;
            dtGrdvCustomerDetails.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            dtGrdvCustomerDetails.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
        ...
        private void txtcustomeMobile_TextChanged(object sender, EventArgs e)
        {
            ...
            Mobile = Mobile.Trim();
            string sqlCmd = "Select ID,(Name ||' - '|| NameArabic) as Name,Mobile,Address,EmailAddress from  customercredit where TenentID=" + Tenent.TenentID + " and PeopleType = 'Customer' and Mobile like '%" + Mobile + "%'  ";
            DataTable dt1 = DataAccess.GetDataTable(sqlCmd);
            dtGrdvCustomerDetails.DataSource = dt1;
            dtGrdvCustomerDetails.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            dtGrdvCustomerDetails.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
        ...
        private void txtEmail_TextChanged(object sender, EventArgs e)
        {
            ...
            string sqlCmd = "Select ID,(Name ||' - '|| NameArabic) as Name,Mobile,Address,EmailAddress from  customercredit where TenentID=" + Tenent.TenentID + " and PeopleType = 'Customer' and EmailAddress like '%" + EmailAddress + "%'   ";
            DataTable dt1 = DataAccess.GetDataTable(sqlCmd);
            dtGrdvCustomerDetails.DataSource = dt1;
            dtGrdvCustomerDetails.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
            dtGrdvCustomerDetails.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
        ...
        private void dtGrdvCustomerDetails_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == dtGrdvCustomerDetails.Columns["Select"].Index && e.RowIndex >= 0)
                {
                    ...
                    mkc1.CustName = dt1.Rows[0]["Name"] + " ~ " + dt1.Rows[0]["ID"] + " ~ " + dt1.Rows[0]["Phone"];
                    mkc1.Show();
                    this.Close();
                }
